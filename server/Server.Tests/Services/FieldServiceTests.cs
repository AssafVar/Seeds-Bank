...
public class FieldServiceTests
{
    ...
    public async Task UpdateGeometryAsync_repositions_a_sub_field_within_its_parent()
    {
        ...
        var moved = await service.UpdateGeometryAsync("p1", subField.Id, SubFieldBoundaryInsideLargeField());
    ...
    public async Task UpdateGeometryAsync_throws_for_a_field_that_is_not_a_sub_field()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() => service.UpdateGeometryAsync("p1", field.Id, SubFieldBoundaryInsideLargeField()));
    }
    ...
    public async Task UpdateGeometryAsync_returns_null_for_a_missing_field()
    {
        ...
        Assert.Null(await service.UpdateGeometryAsync("p1", 999, SubFieldBoundaryInsideLargeField()));
    }
